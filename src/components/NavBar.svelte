<script lang="ts">
  ...
  let { activeTab, onTabChange }: {
    activeTab: 'calendar' | 'log' | 'stats' | 'settings'
    onTabChange: (tab: 'calendar' | 'log' | 'stats' | 'settings') => void
  } = $props()
  ...
  const tabs = [
    ...
    },
    {
      ...
      label: '設定',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1 1 0 0 0 .2 1.1l.1.1a2 2 0 0 1-1.4 3.4h-.2a1 1 0 0 0-1 .7 2 2 0 0 1-1.8 1.3h-.2a2 2 0 0 1-1.8-1.3 1 1 0 0 0-1-.7H11a1 1 0 0 0-1 .7 2 2 0 0 1-1.8 1.3h-.2a2 2 0 0 1-1.4-3.4l.1-.1a1 1 0 0 0 .2-1.1 1 1 0 0 0-.7-.8 2 2 0 0 1-1.3-1.8v-.2a2 2 0 0 1 1.3-1.8 1 1 0 0 0 .7-.8 1 1 0 0 0-.2-1.1l-.1-.1A2 2 0 0 1 5.8 5h.2a1 1 0 0 0 1-.7A2 2 0 0 1 8.8 3h.2a2 2 0 0 1 1.8 1.3 1 1 0 0 0 1 .7h1.2a1 1 0 0 0 1-.7A2 2 0 0 1 15.8 3h.2a2 2 0 0 1 1.8 1.3 1 1 0 0 0 1 .7h.2a2 2 0 0 1 1.4 3.4l-.1.1a1 1 0 0 0-.2 1.1 1 1 0 0 0 .7.8 2 2 0 0 1 1.3 1.8v.2a2 2 0 0 1-1.3 1.8 1 1 0 0 0-.7.8Z"/></svg>`
    }
  ]
</script>
